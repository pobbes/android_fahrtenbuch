...
public class DatabaseHandler extends SQLiteOpenHelper
{
	...
	public void onCreate(SQLiteDatabase db)
	{
		String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_LOGIN + "("
				...
				+ KEY_EMAIL + " TEXT UNIQUE," + KEY_USER_ID + " TEXT,"
				+ KEY_CREATED_AT + " TEXT," + KEY_IS_ADMIN + " TEXT" + ")";
	 ...
	 * */
	public void addUser(String username, String email, String user_id,
			String created_at, String is_admin)
	{
